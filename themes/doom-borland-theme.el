;;; doom-borland-theme.el --- Borland -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: Jan 4, 2025
;; Author: Antonio Petrillo <https://github.com/antonio-petrillo>
;; Maintainer: Antonio Petrillo <https://github.com/antonio-petrillo>
;; Source: https://github.com/ n/vscode-winteriscoming
;;
;;; Commentary:
;;
;; Me like blue.
...
(defgroup doom-borland-theme nil
  "Options for the `doom-borland' theme."
  :group 'doom-themes)

(defcustom doom-borland-no-italics nil
  "If non-nil, no italics will be used."
  :group 'doom-borland-theme
  :type 'boolean)

(defcustom doom-borland-brighter-modeline t
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-borland-theme
  :type 'boolean)

(defcustom doom-borland-brighter-comments t
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-borland-theme
  :type 'boolean)

(defcustom doom-borland-comment-bg doom-borland-brighter-comments
  "If non-nil, comments will have a subtle highlight to enhance their
legibility."
  :group 'doom-borland-theme
  :type 'boolean)

(defcustom doom-borland-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-borland
                "Rip-off of Borland theme."
...
;;; doom-borland-theme.el ends here
